"""Washington SOS UCC filing scraper."""
...
class WashingtonScraper(BaseScraper):
    """Scraper for Washington Secretary of State UCC filings."""
    ...
    def base_url(self) -> str:
        """Return Washington SOS UCC search URL."""
        return "https://ccfs.sos.wa.gov/#/UCC"
    ...
    def build_search_url(self) -> str:
        """Build search URL for recent Washington filings."""
        return f"{self.base_url}?type=recent"

    def parse_response(self, html: str) -> list[dict]:
        """Parse Washington SOS HTML into filing dicts."""
