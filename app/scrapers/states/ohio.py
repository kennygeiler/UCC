...
class OhioScraper(BaseScraper):
    """Scraper for Ohio Secretary of State UCC filings."""
    ...
    def base_url(self) -> str:
        """Return Ohio SOS UCC search URL."""
        return "https://www.sos.state.oh.us/ucc/search"
    ...
    def build_search_url(self) -> str:
        """Build search URL for recent Ohio filings."""
        return f"{self.base_url}?type=recent"

    def parse_response(self, html: str) -> list[dict]:
        """Parse Ohio SOS HTML into filing dicts.

        Args:
            html: Raw HTML from the Ohio SOS portal.
