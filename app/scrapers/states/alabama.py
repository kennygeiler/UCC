"""Alabama SOS UCC filing scraper."""
...
class AlabamaScraper(BaseScraper):
    """Scraper for Alabama Secretary of State UCC filings."""
    ...
    def base_url(self) -> str:
        """Return Alabama SOS UCC search URL."""
        return "https://sos.alabama.gov/business-services/ucc"
    ...
    def build_search_url(self) -> str:
        """Build search URL for recent Alabama filings."""
        return f"{self.base_url}?type=recent"

    def parse_response(self, html: str) -> list[dict]:
        """Parse Alabama SOS HTML into filing dicts."""
