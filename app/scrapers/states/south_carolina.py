"""South Carolina SOS UCC filing scraper."""
...
class SouthCarolinaScraper(BaseScraper):
    """Scraper for South Carolina Secretary of State UCC filings."""
    ...
    def base_url(self) -> str:
        """Return South Carolina SOS UCC search URL."""
        return "https://businessfilings.sc.gov/BusinessFiling/UCCSearch"
    ...
    def build_search_url(self) -> str:
        """Build search URL for recent South Carolina filings."""
        return f"{self.base_url}?type=recent"

    def parse_response(self, html: str) -> list[dict]:
        """Parse South Carolina SOS HTML into filing dicts."""
