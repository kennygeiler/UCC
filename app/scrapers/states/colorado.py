"""Colorado SOS UCC filing scraper."""
...
class ColoradoScraper(BaseScraper):
    """Scraper for Colorado Secretary of State UCC filings."""

    @property
    def state_code(self) -> str:
        """Return CO state code."""
        return "CO"
    ...
    def base_url(self) -> str:
        """Return Colorado SOS UCC search URL."""
        return "https://www.sos.state.co.us/biz/UCCSearchCriteria.do"
    ...
    def build_search_url(self) -> str:
        """Build search URL for recent Colorado filings."""
        return f"{self.base_url}?type=recent"

    def parse_response(self, html: str) -> list[dict]:
        """Parse Colorado SOS HTML into filing dicts."""
