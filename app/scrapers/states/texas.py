...
class TexasScraper(BaseScraper):
    ...
    def base_url(self) -> str:
        """Return Texas SOS UCC search URL."""
        return "https://direct.sos.state.tx.us/ucc/search"
    ...
    def build_search_url(self) -> str:
        """Build search URL for recent Texas filings."""
    ...
    def parse_response(self, html: str) -> list[dict]:
        ...
        Args:
            html: Raw HTML from the Texas SOS portal.
