"""Connecticut SOS UCC filing scraper."""
...
class ConnecticutScraper(BaseScraper):
    """Scraper for Connecticut Secretary of State UCC filings."""

    @property
    def state_code(self) -> str:
        """Return CT state code."""
        return "CT"
    ...
    def base_url(self) -> str:
        """Return Connecticut SOS UCC search URL."""
        return "https://www.concord-sots.ct.gov/CONCORD/online"
    ...
    def build_search_url(self) -> str:
        """Build search URL for recent Connecticut filings."""
        return f"{self.base_url}?type=recent"

    def parse_response(self, html: str) -> list[dict]:
        """Parse Connecticut SOS HTML into filing dicts."""
