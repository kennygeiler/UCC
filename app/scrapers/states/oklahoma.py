"""Oklahoma SOS UCC filing scraper."""
...
class OklahomaScraper(BaseScraper):
    """Scraper for Oklahoma Secretary of State UCC filings."""
    ...
    def base_url(self) -> str:
        """Return Oklahoma SOS UCC search URL."""
        return "https://www.sos.ok.gov/business/ucc.aspx"
    ...
    def build_search_url(self) -> str:
        """Build search URL for recent Oklahoma filings."""
        return f"{self.base_url}?type=recent"

    def parse_response(self, html: str) -> list[dict]:
        """Parse Oklahoma SOS HTML into filing dicts."""
