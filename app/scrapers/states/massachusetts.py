"""Massachusetts SOS UCC filing scraper."""
...
class MassachusettsScraper(BaseScraper):
    """Scraper for Massachusetts Secretary of State UCC filings."""

    @property
    def state_code(self) -> str:
        """Return MA state code."""
        return "MA"
    ...
    def base_url(self) -> str:
        """Return Massachusetts SOS UCC search URL."""
        return "https://corp.sec.state.ma.us/CorpWeb/Ucc/UCCSearch.aspx"
    ...
    def build_search_url(self) -> str:
        """Build search URL for recent Massachusetts filings."""
        return f"{self.base_url}?type=recent"

    def parse_response(self, html: str) -> list[dict]:
        """Parse Massachusetts SOS HTML into filing dicts."""
