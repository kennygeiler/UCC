"""Georgia SOS UCC filing scraper."""
...
class GeorgiaScraper(BaseScraper):
    """Scraper for Georgia Secretary of State UCC filings."""
    ...
    def base_url(self) -> str:
        """Return Georgia SOS UCC search URL."""
        return "https://ecorp.sos.ga.gov/ucc/search"
    ...
    def build_search_url(self) -> str:
        """Build search URL for recent Georgia filings."""
        return f"{self.base_url}?type=recent"

    def parse_response(self, html: str) -> list[dict]:
        """Parse Georgia SOS HTML into filing dicts.

        Args:
            html: Raw HTML from the Georgia SOS portal.
