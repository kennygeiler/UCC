"""Delaware SOS UCC filing scraper."""
...
class DelawareScraper(BaseScraper):
    """Scraper for Delaware Secretary of State UCC filings."""

    @property
    def state_code(self) -> str:
        """Return DE state code."""
        return "DE"
    ...
    def base_url(self) -> str:
        """Return Delaware SOS UCC search URL."""
        return "https://icis.corp.delaware.gov/eCorp/UCCSearch/Search"
    ...
    def build_search_url(self) -> str:
        """Build search URL for recent Delaware filings."""
        return f"{self.base_url}?type=recent"

    def parse_response(self, html: str) -> list[dict]:
        """Parse Delaware SOS HTML into filing dicts."""
