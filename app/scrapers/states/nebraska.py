"""Nebraska SOS UCC filing scraper."""
...
class NebraskaScraper(BaseScraper):
    """Scraper for Nebraska Secretary of State UCC filings."""

    @property
    def state_code(self) -> str:
        """Return NE state code."""
        return "NE"
    ...
    def base_url(self) -> str:
        """Return Nebraska SOS UCC search URL."""
        return "https://www.nebraska.gov/sos/ucc/"
    ...
    def build_search_url(self) -> str:
        """Build search URL for recent Nebraska filings."""
        return f"{self.base_url}?type=recent"

    def parse_response(self, html: str) -> list[dict]:
        """Parse Nebraska SOS HTML into filing dicts."""
