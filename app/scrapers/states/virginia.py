"""Virginia SOS UCC filing scraper."""
...
class VirginiaScraper(BaseScraper):
    """Scraper for Virginia Secretary of State UCC filings."""

    @property
    def state_code(self) -> str:
        """Return VA state code."""
        return "VA"
    ...
    def base_url(self) -> str:
        """Return Virginia SOS UCC search URL."""
        return "https://cis.scc.virginia.gov/EntitySearch/Index"
    ...
    def build_search_url(self) -> str:
        """Build search URL for recent Virginia filings."""
        return f"{self.base_url}?type=recent"

    def parse_response(self, html: str) -> list[dict]:
        """Parse Virginia SOS HTML into filing dicts."""
