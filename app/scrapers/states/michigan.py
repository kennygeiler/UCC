"""Michigan SOS UCC filing scraper."""
...
class MichiganScraper(BaseScraper):
    """Scraper for Michigan Secretary of State UCC filings."""
    ...
    def base_url(self) -> str:
        """Return Michigan SOS UCC search URL."""
        return "https://cofs.lara.state.mi.us/SearchApi/Search/Search"
    ...
    def build_search_url(self) -> str:
        """Build search URL for recent Michigan filings."""
        return f"{self.base_url}?type=recent"

    def parse_response(self, html: str) -> list[dict]:
        """Parse Michigan SOS HTML into filing dicts."""
