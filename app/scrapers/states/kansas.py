...
class KansasScraper(BaseScraper):
    """Scraper for Kansas Secretary of State UCC filings."""

    @property
    def state_code(self) -> str:
        """Return KS state code."""
        return "KS"
    ...
    def base_url(self) -> str:
        """Return Kansas SOS UCC search URL."""
        return "https://www.kansas.gov/bess/flow/main"
    ...
    def build_search_url(self) -> str:
        """Build search URL for recent Kansas filings."""
        return f"{self.base_url}?type=recent"

    def parse_response(self, html: str) -> list[dict]:
        """Parse Kansas SOS HTML into filing dicts."""
