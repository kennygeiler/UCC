...
class NewJerseyScraper(BaseScraper):
    ...
    def base_url(self) -> str:
        """Return New Jersey SOS UCC search URL."""
        return "https://www.njportal.com/dor/ucc/search"
    ...
    def build_search_url(self) -> str:
        """Build search URL for recent New Jersey filings."""
        return f"{self.base_url}?type=recent"

    def parse_response(self, html: str) -> list[dict]:
        """Parse New Jersey SOS HTML into filing dicts.

        Args:
            html: Raw HTML from the New Jersey SOS portal.
