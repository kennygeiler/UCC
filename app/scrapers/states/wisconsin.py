"""Wisconsin SOS UCC filing scraper."""
...
class WisconsinScraper(BaseScraper):
    """Scraper for Wisconsin Secretary of State UCC filings."""

    @property
    def state_code(self) -> str:
        """Return WI state code."""
        return "WI"
    ...
    def base_url(self) -> str:
        """Return Wisconsin SOS UCC search URL."""
        return "https://www.wdfi.org/apps/uccfilings/Search/"
    ...
    def build_search_url(self) -> str:
        """Build search URL for recent Wisconsin filings."""
        return f"{self.base_url}?type=recent"

    def parse_response(self, html: str) -> list[dict]:
        """Parse Wisconsin SOS HTML into filing dicts."""
