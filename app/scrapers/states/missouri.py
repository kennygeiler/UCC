"""Missouri SOS UCC filing scraper."""
...
class MissouriScraper(BaseScraper):
    """Scraper for Missouri Secretary of State UCC filings."""

    @property
    def state_code(self) -> str:
        """Return MO state code."""
        return "MO"
    ...
    def base_url(self) -> str:
        """Return Missouri SOS UCC search URL."""
        return "https://bsd.sos.mo.gov/UCC/UCCSearch.aspx"
    ...
    def build_search_url(self) -> str:
        """Build search URL for recent Missouri filings."""
        return f"{self.base_url}?type=recent"

    def parse_response(self, html: str) -> list[dict]:
        """Parse Missouri SOS HTML into filing dicts."""
