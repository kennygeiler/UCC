"""Minnesota SOS UCC filing scraper."""
...
class MinnesotaScraper(BaseScraper):
    """Scraper for Minnesota Secretary of State UCC filings."""

    @property
    def state_code(self) -> str:
        """Return MN state code."""
        return "MN"
    ...
    def base_url(self) -> str:
        """Return Minnesota SOS UCC search URL."""
        return "https://mblsportal.sos.state.mn.us/UCC/Search"
    ...
    def build_search_url(self) -> str:
        """Build search URL for recent Minnesota filings."""
        return f"{self.base_url}?type=recent"

    def parse_response(self, html: str) -> list[dict]:
        """Parse Minnesota SOS HTML into filing dicts."""
