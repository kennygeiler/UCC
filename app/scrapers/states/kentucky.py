"""Kentucky SOS UCC filing scraper."""
...
class KentuckyScraper(BaseScraper):
    """Scraper for Kentucky Secretary of State UCC filings."""

    @property
    def state_code(self) -> str:
        """Return KY state code."""
        return "KY"
    ...
    def base_url(self) -> str:
        """Return Kentucky SOS UCC search URL."""
        return "https://app.sos.ky.gov/ftsearch/"
    ...
    def build_search_url(self) -> str:
        """Build search URL for recent Kentucky filings."""
        return f"{self.base_url}?type=recent"

    def parse_response(self, html: str) -> list[dict]:
        """Parse Kentucky SOS HTML into filing dicts."""
